...
<head>
	...
	<title>Blood Bank & Donor Management System | Admin Login</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Blood Bank & Donor Management System Sign in</h1>
